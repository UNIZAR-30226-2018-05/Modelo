...
interface FacadeInterface{
     ...
     * @param limit: Maximum number of songs in the view
     */
    fun fetchSongsByName(name: String, pag: Int, limit: Int) : SongList
     ...
     */
    fun fetchSongById(id: String) : Song

    /**
     * Call the API to download the file Song
     * Param:
     * @param id: Identificator's songs
     */
     ...
     * @param limit: Maximum number of songs in the view
     */
    fun fetchPlaylistByName(name: String, pag: Int, limit: Int) : List<SongList>
     ...
     * @param limit: Maximum number of songs in the view
     */
    fun fetchPlaylistByOwner(owner: User, pag: Int, limit: Int) : List<SongList>
     ...
     * @param limit: Maximum number of songs in the view
     */
    fun fetchPlaylistById(id: String, pag: Int, limit: Int) : SongList
