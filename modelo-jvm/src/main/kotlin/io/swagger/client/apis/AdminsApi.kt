...
class AdminsApi(basePath: kotlin.String = "https://virtserver.swaggerhub.com/miguescri/ProySoft/1.0.0") : ApiClient(basePath) {
    ...
    * @param albumItem Playlist item to add (optional)
    * @return AlbumItem
    */
    ...
    * @param albumID ID de la playlist 
    * @return void
    */
    ...
    * @param albumID ID de la canción 
    * @return void
    */
    ...
    * @param albumID ID de la canción 
    * @param albumImage Song item to update 
    * @return void
    */
    ...
    * Un admin carga el archivo de audio de una canción con identificador songID.
    * @param songID ID de la canción 
    * @param songImage Song item to update 
    * @return void
    */
